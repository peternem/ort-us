...
if (($user_role1 === $GLOBALS['ort_premier_role']) || ($user_role1 === $GLOBALS['ort_champion_role']) || ($user_role1 === $GLOBALS['ort_div_one_role']) || ($user_role1 === $GLOBALS['ort_div_two_role']) || ($user_role1 === $GLOBALS['ort_div_two_role'])) {
    $GLOBALS['role_flag'] = 1;
} else {
    $GLOBALS['role_flag'] = 0;
}